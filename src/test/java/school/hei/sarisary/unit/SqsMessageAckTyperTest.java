package school.hei.sarisary.unit;
...
import school.hei.sarisary.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("school.hei.sarisary.endpoint.event.gen.UuidCreated", payload);
